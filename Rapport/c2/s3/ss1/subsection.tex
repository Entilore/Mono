...
Pour l'entreprise, l'éco-participation a été un véritable moteur, qui lui a permis de se développer. Elle compte aujourd'hui 92 employés. Le marché de la réindustrialisation a attiré de nombreuses nouvelles entreprises de recyclage, fondées à la suite du décret. 
...
Autre point surprenant : les déchets de Nantes sont envoyés à Angers ou à Rennes (90 ou 110 km).   Les déchets sont donc déplacés, puis brûlés. La production de \textit{CO2} n'est donc pas négligeable. 

\bigbreak

Ainsi, le recyclage des \textit{DEEE} est obligatoire. Une partie des déchets est réinjectée dans le marché suite à une rénovation, cependant, une partie des objets n'ayant pas pu être sauvée sera brûlée, contribuant ainsi au réchauffement climatique. Le recyclage reste malgré tout une bonne solution, cependant des progrès restent à faire. 
\medbreak
