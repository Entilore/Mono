...
Après leur extraction, les matières premières sont rassemblées, transportées, puis transformées en d'autres composés, qui seront eux-même possiblement traités ou consommés dans des processus divers. Tout cela a malheureusement un coût parfois important pour l'environnement.
...
\begin{figure}[!h]
\centerline{\includegraphics[scale=0.50]{Rsc/pollution_maritime.png}}
