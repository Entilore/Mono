...
Le fil rouge du reportage \textit{Prêt à jeter} représente un informaticien donc l'imprimante ne fonctionne plus. La machine, de marque HP, indique qu'elle doit être réparée. Il décide donc d'essayer de la réparer. Il rencontre donc plusieurs réparateur. Tous lui conseillent d'acheter une nouvelle imprimante, le prix de la réparation étant plus élevé que celui d'une imprimante neuve. 
