\section{Bruno Clémentin}
\label{InterviewBClémentin}


%\item[Jean Chorin et Maximilien Richer] 
...
\textbf{Oui, mais encore une fois, le vice caché, ça dure longtemps. Je crois que la prescription, c'est de l'ordre de dix ans au sens du code civile. SI vous achetez quelque chose et qu'il a un vice caché. Ou c'est peut-être que trois ans, je ne suis pas certain. Mais oui on pourrait le mettre.}
